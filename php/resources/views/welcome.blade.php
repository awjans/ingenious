...
@section('content')
  <div class="row">
    <div class="col-6 col-md-3">
      ...
      <div><img class="w-100" src="/images/welcome1.jpg" alt="@lang('website.welcome1-alt')"></div>
    </div>
    <div class="col-6 col-md-3">
      <div><img class="w-100" src="/images/welcome2.jpg" alt="@lang('website.welcome2-alt')"></div>
    ...
    <div class="col-6 col-md-3">
      ...
      <div><img class="w-100" src="/images/welcome3.jpg" alt="@lang('website.welcome3-alt')"></div>
    </div>
    <div class="col-6 col-md-3">
      <div><img class="w-100" src="/images/welcome4.jpg" alt="@lang('website.welcome4-alt')"></div>
