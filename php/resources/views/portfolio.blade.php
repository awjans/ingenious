...
@section('content')
<h1>@lang('website.portfolio')</h1>
<h2>Hawaii Select Investments Inc</h2>
<p>@lang('services.types.tech_support'), @lang('services.types.strategic_advice')</p>
<h2><a href="https://www.cranetech.pro" target="ipclient">Crane Tech LLC</a></h2>
<p>@lang('services.types.tech_support'), @lang('services.types.sys_admin')</p>
...
<p>@lang('services.types.web_design'), @lang('services.types.tech_support'), @lang('services.types.strategic_advice')</p>
